...
class BioIKSolver{
    public:
        BioIKSolver();
        BioIKSolver(const robot_state::JointModelGroup &all_joints_group, const robot_state::JointModelGroup &legs_joints_group, const robot_state::JointModelGroup &lleg_joints_group, const robot_state::JointModelGroup &rleg_joints_group);
        ...
        void set_single_chain(bool single_chain);
        void set_bioIK_timeout(double timeout);
    private:
        bool _use_approximate;
        bool _bioIKSingleChain;
