...
void QuinticWalk::buildTrajectories()
{
    ...
    if (!_isEnabled) {
        ...
        _trajs.get("foot_pos_y").addPoint(
            ...
            -supportSign*_params("footDistance")
                ...
                *_params("footOvershootRatio"));
        _trajs.get("foot_pos_y").addPoint(
            singleSupportLength, -supportSign*_params("footDistance"));                
        _trajs.get("foot_pos_y").addPoint(
        ...
        if (_wasEnabled) {
            ...
            _trajs.get("foot_pos_z").addPoint(
                ...
                _params("footRise"));
            _trajs.get("foot_pos_z").addPoint(
                singleSupportLength, _params("footPutDownZOffset"));
            _trajs.get("foot_pos_z").addPoint(
                singleSupportLength + _params("footPutDownPhase") * doubleSupportLength , 0.0);
            _trajs.get("foot_pos_z").addPoint(
                halfPeriod, 0.0);
    ...
    _trajs.get("foot_pos_z").addPoint(
        0.0, 0.0);    
    float apex_time = singleSupportLength*_params("footApexPhase");
    _trajs.get("foot_pos_z").addPoint(
        apex_time, 
        _params("footRise"));
    _trajs.get("foot_pos_z").addPoint(
    ...
    _trajs.get("trunk_pos_y").addPoint(
        ...
        _trunkVelAtLast.y(), 
        _trunkAccAtLast.y()); 
    if(_params("trunkYOnlyInDoubleSupport")){  
        _trajs.get("trunk_pos_y").addPoint(
